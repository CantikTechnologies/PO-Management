...
echo "<h1>Fix All Outsourcing Data</h1>";
    ...
    if ($tableCheck && $tableCheck->num_rows > 0) {
        ...
        while ($row = $data->fetch_assoc()) {
            ...
            if ($mysqli->query($updateSql)) {
                $updatedCount++;
                echo "<p style='color: green;'>✅ Fixed ID $id: " . 
                     "Vendor Inv: ₹" . number_format($vendorInvValue, 2) . 
        ...
        $finalData = $mysqli->query("SELECT * FROM outsourcing_detail ORDER BY id");
...
echo "<p><a href='test_js_data.php'>Test JavaScript Data</a></p>";
?>
